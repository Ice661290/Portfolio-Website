...
const Activity = () => {
  ...
  const activities = [
    ...
    },
    {
      ...
      desc: 'A program focused on turning creative ideas into real-world startup innovations and competing in pitching rounds to advance to the Top 5 finalists for the National Final Pitching.',
      img: '/images/StartUpLeague.jpg',
    },
    {
      id: 5,
      title: 'HCU OPEN HOUSE 2025',
      desc: 'At our booth, we had an amazing time sharing our experiences.We showed them how to actually make LAN cables and let them put on VR headsets to explore some awesome virtual worlds together.',
      img: '/images/Openhouse.png',
    },
    {
      id: 6,
    ...
    <section id="activity" className="py-24 bg-white dark:bg-slate-900 transition-colors duration-300 relative">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {activities.map(act => (
            <div key={act.id} className="w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.5rem)] bg-blue-100 dark:bg-slate-800 flex flex-col rounded-3xl overflow-hidden shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-blue-200 dark:border-slate-700">
